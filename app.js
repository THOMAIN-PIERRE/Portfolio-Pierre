...
.pauseFor(1800)
.changeDelay(20)
.typeString('Je suis Pierre Thomain')
.pauseFor(300)
.typeString(', Développeur <strong style="color: white;">FULL-STACK !</strong>')
.pauseFor(1000)
.deleteChars(13)
.typeString('<strong style="color: orange;"> HTML !</strong>')
.pauseFor(1000)
.deleteChars(6)
.typeString('<strong style="color: pink;"> CSS !</strong>')
.pauseFor(1000)
.deleteChars(5)
.typeString('<strong style="color: #ff6910;"> JAVASCRIPT !</strong>')
.pauseFor(1000)
.deleteChars(12)
.typeString('<strong style="color: #EA39ff;"> PHP !</strong>')
.pauseFor(1000)
.deleteChars(5)
.typeString('<strong style="color: yellow;"> <b>SYMFONY !</b></strong>')
.pauseFor(1000)
.deleteChars(9)
.typeString('<strong style="color: red;"> ANGULAR !</strong>')
.pauseFor(1000)
.deleteChars(9)
.typeString('<strong style="color: blue;"> NATIVESCRIPT !</strong>')
.pauseFor(1000)
.deleteChars(14)
.typeString('<strong style="color: white;"> FULL-STACK !</strong>')
.start()
